...
class ArgumentParser:
    def parse_arguments(self):
        ...
        parser.add_argument('-a', '--APKEditor', action='store_true', help=f'{C.y}➸ {C.g}APKEditor ( Default APKTool ){C.c}')
        group.add_argument('-m', dest='Merge', help=f'{C.y}➸{C.g} Anti-Split ( Only Merge Apk ){C.c}')
        group.add_argument('-L', dest='AES_Logs', help=f'{C.y}➸{C.g} AES MT Logs Inject{C.c}')
        group.add_argument('-rm', dest='Remove_Ads', help=f'{C.y}➸{C.g} Ads Remove/Patching{C.c}')
