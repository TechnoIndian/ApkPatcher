        ...
        for File_URL, File_Path, Expected_CheckSum in Jar_Files:
            ...
            try:
                ...
                if Version != str(__version__):
                    ...
                    cmd = (["pip", "install", "git+https://github.com/TechnoIndian/ApkPatcher.git"] if M.os.name == "nt" else "pip install --force-reinstall https://github.com/TechnoIndian/ApkPatcher/archive/refs/heads/main.zip")
